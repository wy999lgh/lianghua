  ...
  <div class="grid-config">
    <el-card class="card">
      ...
      <el-form :model="gridConfig" label-width="120px" class="grid-form">
        ...
        <el-form-item label="每上涨幅度">
          <el-input-number v-model="gridConfig.upper_step" :min="0.01" :step="0.01" placeholder="请输入每上涨幅度（百分比）" />
        </el-form-item>

        <el-form-item label="每下跌幅度">
          <el-input-number v-model="gridConfig.lower_step" :min="0.01" :step="0.01" placeholder="请输入每下跌幅度（百分比）" />
        </el-form-item>
